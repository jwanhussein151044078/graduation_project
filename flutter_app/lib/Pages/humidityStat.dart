...
class humidityStat extends StatefulWidget {
  @override
  _humidityStatState createState() => _humidityStatState();
}

class _humidityStatState extends State<humidityStat> {
  List<data> l = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Humidity Statistics"),
          centerTitle: true,

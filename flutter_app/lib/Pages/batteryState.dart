...
class batteryStat extends StatefulWidget {
  @override
  _batteryStatState createState() => _batteryStatState();
}

class _batteryStatState extends State<batteryStat> {
  List<data> l = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text("Battery Statistics"),
          centerTitle: true,
